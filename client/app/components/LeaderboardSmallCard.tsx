...
function LeaderboardSmallCard({ celebLeaderboardEntry, placing }: Props) {
  ...
  return (
    <div className="flex justify-center font-medium text-blue-50">
      <div className="flex w-full items-center justify-between divide-x-2 divide-zinc-800/30 rounded-lg bg-zinc-700 py-2 text-xl sm:w-11/12">
